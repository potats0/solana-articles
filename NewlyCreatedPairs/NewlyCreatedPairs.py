...
from FetchingSPLMeta import get_token_meta, get_token_metav2

# Raydium Liquidity Pool V4
RaydiumLPV4 = "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8"
URI = "https://api.devnet.solana.com"  # "https://api.devnet.solana.com" | "https://api.mainnet-beta.solana.com"
WSS = "wss://api.devnet.solana.com"  # "wss://api.devnet.solana.com" | "wss://api.mainnet-beta.solana.com"
...
def print_table(tokens: Tuple[Pubkey, Pubkey, Pubkey]) -> None:
    ...
    token_meta = get_token_metav2(tokens[0])
